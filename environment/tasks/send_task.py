...
def send_task(task):
    ...
    channel.queue_declare(queue=database_configuration['queue'], durable=True) # Se agrega el durable=True para garantizar durabilidad del mensaje.
                                                                               # Nos aseguramos que la cola, no se perderá incluso si se reinicia el RabbitMQ
